...
class _WeatherScreenState extends State<WeatherScreen>
            ...
            PopupMenuButton<OptionsMenu>(
                ...
                itemBuilder: (context) => <PopupMenuEntry<OptionsMenu>>[
                      PopupMenuItem<OptionsMenu>(
                        ...
                        child: Text("Choose your city"),//textStyle: TextStyle(fontSize: 24),
                      ),
                      PopupMenuItem<OptionsMenu>(
                        value: OptionsMenu.settings,
                        child: Text("Settings"),//textStyle: TextStyle(fontSize: 24),
                      ),
                    ])
          ],
        ),
  ...
  _fetchWeatherWithCity() {
    _weatherBloc.dispatch(WeatherFetching(cityName: _cityName));
  }
  ...
  _fetchWeatherWithLocation() async {
    ...
    _weatherBloc.dispatch(WeatherFetching(
